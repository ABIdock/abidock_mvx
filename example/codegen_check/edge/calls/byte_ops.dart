...
/// Calls byteOps endpoint.
///
/// #### Parameters:
/// - `hash`: ManagedByteArray&lt;32&gt;
/// - `blob`: bytes
///
/// #### Throws:
...
Future<Transaction> byteOps(
  ...
  final probeTx = factory.createCall(
    ...
    nonce: nonce,
    endpointName: 'byteOps',
    arguments: <dynamic>[hash, blob],
...
/// Builds an unsigned transaction for byteOps endpoint.
/// #### Parameters:
/// - `hash`: ManagedByteArray&lt;32&gt;
/// - `blob`: bytes
///
...
/// final tx1 = await byteOpsUnsigned(factory, provider, sender, nonce1, ...);
