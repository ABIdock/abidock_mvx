...
/// Calls countedVar endpoint.
///
/// #### Parameters:
/// - `ids`: counted-variadic&lt;TokenIdentifier&gt;
///
/// #### Throws:
...
Future<Transaction> countedVar(
  ...
  final probeTx = factory.createCall(
    ...
    nonce: nonce,
    endpointName: 'countedVar',
    arguments: <dynamic>[
      VariadicValue.counted(
        ids.map((e) => TokenIdentifierType.type.createValue(e.value)).toList(),
        itemType: TokenIdentifierType.type,
      ),
    ],
...
/// Builds an unsigned transaction for countedVar endpoint.
/// #### Parameters:
/// - `ids`: counted-variadic&lt;TokenIdentifier&gt;
///
/// #### Returns:
...
/// final tx1 = await countedVarUnsigned(factory, provider, sender, nonce1, ...);
