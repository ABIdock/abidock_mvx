...
/// Calls specificToken endpoint.
///
/// #### Payable:
/// ESDT tokens (XYZ-aaaaaa)
///
/// #### Throws:
...
/// Builds an unsigned transaction for specificToken endpoint.
/// #### Returns:
...
/// final tx1 = await specificTokenUnsigned(factory, provider, sender, nonce1, ...);
