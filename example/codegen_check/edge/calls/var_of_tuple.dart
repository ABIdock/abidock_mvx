...
/// Calls varOfTuple endpoint.
///
/// #### Parameters:
/// - `items`: variadic&lt;multi&lt;u32,Address&gt;&gt;
///
/// #### Throws:
...
Future<Transaction> varOfTuple(
  ...
  final probeTx = factory.createCall(
    ...
    nonce: nonce,
    endpointName: 'varOfTuple',
    arguments: <dynamic>[
      items.map((e) => <dynamic>[e.$1, e.$2]).toList(),
    ],
...
/// Builds an unsigned transaction for varOfTuple endpoint.
/// #### Parameters:
/// - `items`: variadic&lt;multi&lt;u32,Address&gt;&gt;
///
/// #### Returns:
...
/// final tx1 = await varOfTupleUnsigned(factory, provider, sender, nonce1, ...);
