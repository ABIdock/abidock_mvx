...
import 'package:abidock_mvx/abidock_mvx.dart' hide EsdtTokenPayment;
...
class PairController {
  ...
  Future<BigInt> getAmountOut(TokenIdentifier tokenIn, BigInt amountIn) =>
  ...
  Future<BigInt> getEquivalent(TokenIdentifier tokenIn, BigInt amountIn) =>
  ...
  Future<Address> getLockingScAddress() =>
  ...
  Future<int> getPermissions(Address address) =>
  ...
  Future<Transaction> removeLiquidityAndBuyBackAndBurnToken(
    IAccount sender,
    Nonce nonce,
    TokenIdentifier tokenToBuybackAndBurn, {
    List<TokenTransferValue> tokenTransfers = const <TokenTransferValue>[],
    Address? relayer,
    Address? guardian,
    Balance? value,
  ...
  Future<Transaction> addTrustedSwapPair(
    ...
    Nonce nonce,
    Address pairAddress,
    TokenIdentifier firstToken,
    TokenIdentifier secondToken, {
    Address? relayer,
    Address? guardian,
    Balance? value,
