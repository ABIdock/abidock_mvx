...
final class MultiEventWebSocketStream {
  ...
  Stream<SwapNoFeeAndForwardEventData> get swapNoFeeAndForward =>
  ...
  Stream<AddLiquidityEventData> get addLiquidity =>
  ...
  Stream<RemoveLiquidityEventData> get removeLiquidity =>
      EventConverter.filterByIdentifier<RemoveLiquidityEventData>(
        _stream.events,
        'remove_liquidity',
        (parsed) => EventConverter.convertEvent<RemoveLiquidityEventData>(
          parsed,
