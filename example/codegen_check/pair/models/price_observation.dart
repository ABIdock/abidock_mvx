...
class PriceObservation {
  ...
  factory PriceObservation.fromAbi(TypedValue value) {
    ...
    return PriceObservation(
      firstTokenReserveAccumulated:
          struct.getFieldValue('first_token_reserve_accumulated').nativeValue
              as BigInt,
      secondTokenReserveAccumulated:
          struct.getFieldValue('second_token_reserve_accumulated').nativeValue
              as BigInt,
      weightAccumulated:
          struct.getFieldValue('weight_accumulated').nativeValue as BigInt,
      recordingRound:
          struct.getFieldValue('recording_round').nativeValue as BigInt,
    );
  }
