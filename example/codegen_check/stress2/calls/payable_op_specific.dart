...
/// Calls payableOpSpecific endpoint.
///
/// #### Payable:
/// ESDT tokens (XYZ-aaaaaa, ABC-bbbbbb)
///
/// #### Throws:
...
Future<Transaction> payableOpSpecific(
  ...
  final probeTx = factory.createCall(
    ...
    nonce: nonce,
    endpointName: 'payableOpSpecific',
...
/// Builds an unsigned transaction for payableOpSpecific endpoint.
/// #### Returns:
...
/// final tx1 = await payableOpSpecificUnsigned(factory, provider, sender, nonce1, ...);
