...
/// Calls addToPauseWhitelist endpoint.
///
/// #### Parameters:
...
Future<Transaction> addToPauseWhitelist(
  ...
  final simulationTx = await controller.call(
    account: sender,
    nonce: nonce,
    endpointName: 'addToPauseWhitelist',
...
/// Builds an unsigned transaction for addToPauseWhitelist endpoint.
/// #### Parameters:
/// - `addressList`: variadic&lt;Address&gt;
///
/// #### Returns:
...
/// final tx1 = addToPauseWhitelistUnsigned(factory, sender, nonce1, ...);
