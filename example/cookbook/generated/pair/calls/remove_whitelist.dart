...
/// Calls removeWhitelist endpoint.
///
/// #### Parameters:
/// - `address`: Address
///
...
/// Builds an unsigned transaction for removeWhitelist endpoint.
/// #### Parameters:
/// - `address`: Address
///
/// #### Returns:
...
/// final tx1 = removeWhitelistUnsigned(factory, sender, nonce1, ...);
