...
/// Calls setLockingScAddress endpoint.
///
/// #### Parameters:
/// - `newAddress`: Address
///
...
Future<Transaction> setLockingScAddress(
  ...
  final simulationTx = await controller.call(
    account: sender,
    nonce: nonce,
    endpointName: 'setLockingScAddress',
    arguments: <dynamic>[newAddress],
    value: value,
...
/// Builds an unsigned transaction for setLockingScAddress endpoint.
/// #### Parameters:
/// - `newAddress`: Address
///
/// #### Returns:
...
/// final tx1 = setLockingScAddressUnsigned(factory, sender, nonce1, ...);
