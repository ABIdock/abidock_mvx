...
/// Calls setStateActiveNoSwaps endpoint.
///
/// #### Throws:
...
Future<Transaction> setStateActiveNoSwaps(
  ...
  final simulationTx = await controller.call(
    account: sender,
    nonce: nonce,
    endpointName: 'setStateActiveNoSwaps',
    value: value,
...
/// Builds an unsigned transaction for setStateActiveNoSwaps endpoint.
/// #### Returns:
...
/// final tx1 = setStateActiveNoSwapsUnsigned(factory, sender, nonce1, ...);
