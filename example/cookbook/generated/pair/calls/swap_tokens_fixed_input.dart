...
/// Calls swapTokensFixedInput endpoint.
///
/// #### Payable:
/// EGLD, ESDT tokens
///
...
Future<Transaction> swapTokensFixedInput(
  ...
  final simulationTx = await controller.call(
    ...
    arguments: <dynamic>[tokenOut, amountOutMin],
...
/// Builds an unsigned transaction for swapTokensFixedInput endpoint.
/// #### Parameters:
/// - `tokenOut`: TokenIdentifier
/// - `amountOutMin`: BigUint
///
...
/// final tx1 = swapTokensFixedInputUnsigned(factory, sender, nonce1, ...);
