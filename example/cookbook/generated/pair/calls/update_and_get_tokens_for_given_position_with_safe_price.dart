...
/// Calls updateAndGetTokensForGivenPositionWithSafePrice endpoint.
///
/// #### Parameters:
/// - `liquidity`: BigUint
///
...
Future<Transaction> updateAndGetTokensForGivenPositionWithSafePrice(
  ...
  final simulationTx = await controller.call(
    account: sender,
    nonce: nonce,
    endpointName: 'updateAndGetTokensForGivenPositionWithSafePrice',
    arguments: <dynamic>[liquidity],
    value: value,
...
/// Builds an unsigned transaction for updateAndGetTokensForGivenPositionWithSafePrice endpoint.
/// #### Parameters:
/// - `liquidity`: BigUint
///
/// #### Returns:
...
/// final tx1 = updateAndGetTokensForGivenPositionWithSafePriceUnsigned(factory, sender, nonce1, ...);
