...
enum State {
  ...
  static final type = EnumType(name: 'State', variants: [const EnumVariantDefinition(name: 'Inactive', discriminant: 0), const EnumVariantDefinition(name: 'Active', discriminant: 1), const EnumVariantDefinition(name: 'PartialActive', discriminant: 2)]);
  ...
  factory State.fromAbi(TypedValue value) {
    ...
    if (nativeValue is String) {
      return State.values.firstWhere(
        ...
        orElse: () => throw ArgumentError('Unknown State variant: $nativeValue'),
      );
    }
