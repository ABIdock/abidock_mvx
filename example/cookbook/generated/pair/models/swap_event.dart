...
class SwapEvent {
  ...
  factory SwapEvent.fromAbi(TypedValue value) {
    ...
    return SwapEvent(
      ...
      tokenInReserve: infer<BigInt>(struct.getFieldValue('token_in_reserve').nativeValue),
      tokenOutReserve: infer<BigInt>(struct.getFieldValue('token_out_reserve').nativeValue),
