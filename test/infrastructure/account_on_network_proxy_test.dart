/// Tests for [AccountOnNetwork.fromProxyResponse] focusing on the
/// supernova-era `codeMetadata` base64 decoding path (audit H2-9).
library;
...
void main() {
  group('AccountOnNetwork.fromProxyResponse / codeMetadata', () {
    ...
    test('explicit boolean flags win over decoded bitmap', () {
      /// Bitmap says upgradeable, but the gateway also surfaces an
